    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      {isSuccess ? (
        ...
        <>
          ...
          <div className="mt-8 rounded-2xl border border-blue-400/40 bg-blue-500/10 px-4 py-3 text-sm text-blue-100">
            {t("advancePaymentNotice")}
          </div>

          <div className="mt-4 glass rounded-3xl p-8 text-white">
          ...
          <div className="mt-8 glass rounded-3xl p-8 text-white">
            ...
            <div className="mt-6">
              ...
              >
                {loading ? t("creatingOrder") : t("payNow")}
              </button>
            </div>
          </div>
        </>
