...
router.post("/", protect, adminOnly, async (req, res) => {
  try {
    const { name, price, image, images, description, stock, preorderDate, sizes, unavailableSizes } = req.body;
...
router.put("/:id", protect, adminOnly, async (req, res) => {
  try {
    ...
    if (unavailableSizes !== undefined) {
      product.unavailableSizes = Array.isArray(unavailableSizes) ? unavailableSizes : [];
    }
